...
const Services = () => {
  ...
  const handleAddToCart = (product, event) => {
    ...
    // Calculate existing quantity if product already in cart
    ...
    // After animation finishes, update the cart
    setTimeout(() => {
      if (existingItem) {
  ...
  return (
    ...
    >
      <div className="services-container">
        ...
        {/* Search and filter controls with cart */}
        <div className="product-controls">
          ...
          <div className="filters-cart-container">
            <div className="category-filters">
              ...
              {/* <div className="cart-icon-container" ref={cartIconRef}>
        ...
        {cartAnimation.active && (
          <div 
            ...
            style={{
              position: 'fixed',
              left: cartAnimation.startX,
              top: cartAnimation.startY,
              zIndex: 9999,
              animation: 'moveToCart 0.8s ease-out forwards'
            }}
          >
            <div className="cart-animation-circle">
              +{cartAnimation.quantity}
            </div>
          </div>
        )}
