...
//   useEffect(() => {
//     // Show About Us content with delay for smooth scroll effect
...
//   return (
//     <section id="about" className={`about-section ${showAboutContent ? 'fade-in' : ''}`}>
...
//             <h3>Crafting Excellence Since 2010</h3>
//             <p>
...
import React, { useState, useEffect } from 'react';
// Remove the CSS import - we'll add these styles to your existing CSS file
